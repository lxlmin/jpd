    ...
    <div class="">
        <div class="bg-black w-screen h-screen flex flex-wrap absolute pb-[12vw]">
            ...
            <div class="w-[100%] h-[54vw] absolute top-[12%]">
                <!-- 视频控件 -->
                <div v-if="vioul"  @click="toggleplay">
                    <video id="player" ref="player" playsinline controls style="--plyr-control-icon-size:0px">
                        <source :src="vioul" type="video/mp4" />
                    </video>
                </div>
                <!-- 视频控件 -->
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="1em" height="1em" viewBox="0 0 24 24" class="absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] text-[14vw] text-[rgba(255,255,255,0.4)] iconify iconify--solar" style="display: none;"><path fill="currentColor" d="M21.409 9.353a2.998 2.998 0 0 1 0 5.294L8.597 21.614C6.534 22.737 4 21.277 4 18.968V5.033c0-2.31 2.534-3.769 4.597-2.648l12.812 6.968Z"></path></svg>
            </div> 
            <!-- 第二块 -->
            <div class="w-[100%] absolute bottom-[0vw]">
                <div class="flex justify-between px-[4vw] items-end pb-[3vw]">
                    <div class="flex-1 mr-[10vw] ">
                        <div class="flex items-center mb-[3vw]">
                            ...
                            <div class="bg-[#eb4d44] h-[5vw] w-[7vw] flex items-center justify-center rounded-[2vw]">
                                ...
                                <path fill="currentColor" d="M10.5 20a1.5 1.5 0 0 0 3 0v-6.5H20a1.5 1.5 0 0 0 0-3h-6.5V4a1.5 1.5 0 0 0-3 0v6.5H4a1.5 1.5 0 0 0 0 3h6.5V20Z"></path></g></svg>
                            </div>
                        </div> 
                    ...
                    <div class="w-[10vw]">
                        <div class="flex items-center flex-wrap justify-center mb-[4vw]"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="1em" height="1em" viewBox="0 0 24 24" class="text-[6vw] mb-[2vw] text-[#eaeaea] iconify iconify--bxs"><path fill="currentColor" d="M4 21h1V8H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2zM20 8h-7l1.122-3.368A2 2 0 0 0 12.225 2H12L7 7.438V21h11l3.912-8.596L22 12v-2a2 2 0 0 0-2-2z"></path></svg> 
                            <span class="text-[#eaeaea] text-[3vw]">1885</span>
                        </div> 
                        <div class="flex items-center flex-wrap justify-center mb-[4vw]"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="1em" height="1em" viewBox="0 0 24 24" class="text-[6vw] mb-[2vw] text-[#eaeaea] iconify iconify--uis"><path fill="currentColor" d="M12 2C6.5 2 2 6.5 2 12c0 2.3.8 4.5 2.3 6.3l-2 2c-.4.4-.4 1 0 1.4c.2.2.4.3.7.3h9c5.5 0 10-4.5 10-10S17.5 2 12 2zM8 13c-.6 0-1-.4-1-1s.4-1 1-1s1 .4 1 1s-.4 1-1 1zm4 0c-.6 0-1-.4-1-1s.4-1 1-1s1 .4 1 1s-.4 1-1 1zm4 0c-.6 0-1-.4-1-1s.4-1 1-1s1 .4 1 1s-.4 1-1 1z"></path></svg> 
                            <span class="text-[#eaeaea] text-[3vw]">233</span>
                        </div> 
                        <div class="flex items-center flex-wrap justify-center mb-[4vw]"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="1em" height="1em" viewBox="0 0 24 24" class="text-[6vw] mb-[2vw] text-[#eaeaea] iconify iconify--majesticons"><path fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m20 12l-6.4-7v3.5C10.4 8.5 4 10.6 4 19c0-1.167 1.92-3.5 9.6-3.5V19l6.4-7z"></path></svg>
                            <span class="text-[#eaeaea] text-[3vw]">291</span>
                        </div> 
                        <div class="flex items-center flex-wrap justify-center mb-[4vw]"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="1em" height="1em" viewBox="0 0 24 24" class="text-[6vw] mb-[2vw] text-[#eaeaea] iconify iconify--fluent"><path fill="currentColor" d="M9.113 8.8c.34-.297.744-.526 1.19-.661l.247-.065l.16-.03l.176-.025l.18-.015l.184-.005h7.5a3.25 3.25 0 0 1 3.245 3.065l.005.185v7.5a3.25 3.25 0 0 1-3.066 3.245l-.184.005h-7.5a3.25 3.25 0 0 1-3.245-3.066L8 18.75v-7.5l.003-.149l.014-.19l.026-.191l.036-.186l.059-.223l.08-.236l.087-.202l.082-.162l.094-.163l.146-.217l.094-.123l.135-.156l.108-.112l.149-.139ZM15 11a.75.75 0 0 0-.743.648l-.007.102v2.499h-2.5a.75.75 0 0 0-.743.648l-.007.102c0 .38.282.693.648.743l.102.007h2.5v2.501c0 .38.282.694.648.743L15 19a.75.75 0 0 0 .743-.648l.007-.102v-2.501h2.5a.75.75 0 0 0 .743-.649L19 15a.75.75 0 0 0-.648-.743l-.102-.007h-2.5v-2.5a.75.75 0 0 0-.648-.743L15 11Zm.582-6.767l.052.177l.694 2.588H11.25A4.25 4.25 0 0 0 7 11.249v6.434a3.252 3.252 0 0 1-2.895-2.228l-.052-.176l-1.941-7.245a3.25 3.25 0 0 1 2.12-3.928l.178-.052l7.244-1.941a3.25 3.25 0 0 1 3.928 2.12Z"></path></svg> 
                ...
                <div class="text-[5vw] flex items-center justify-center h-[44vw]" style="display: none;">
                    <span class="text-[#ffffff]">00:00</span> <span class="text-[#666666]">/00:00</span>
                </div> 
                <div class="videoProgressBar vue-slider vue-slider-ltr" style="padding: 7px 0px; width: auto; height: 4px;">
                    <div class="vue-slider-rail">
                        <div class="vue-slider-process" style="height: 100%; top: 0px; left: 0%; width: 0%; transition-property: width, left; transition-duration: 0s;"></div>
                        <div aria-valuetext="0" class="vue-slider-dot" role="slider" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" aria-orientation="horizontal" tabindex="0" style="width: 14px; height: 14px; transform: translate(-50%, -50%); top: 50%; left: 0%; transition: left 0s ease 0s;">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="1em" height="1em" viewBox="0 0 24 24" class="text-[4vw] iconify iconify--bx"><g transform="rotate(-90 12 12)"><path fill="currentColor" d="M5 12H3v9h9v-2H5zm7-7h7v7h2V3h-9z"></path></g></svg>
                </div>
            </div>
        </div> 
    </div>
...
export default {
    ...
    async created(){
        const [err, res] = await getMvvio({
            id:this.$route.query.id,
            named:this.$route.query.name,
            artistName:this.$route.query.artistName,
        });
        if (err) return alert(err);
           console.log(res);
           this.vioul = res.data.data.url
        // console.log(this.vioul);
    },
